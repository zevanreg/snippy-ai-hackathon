...
var tags = { 'azd-env-name': environmentName, project: 'snippy-ai-hackathon', level: 'level-4' }
...
// Deploy Level 4 resources (Blob Storage Triggers & Enhanced Monitoring)
module level4Resources 'resources.bicep' = {
...
// ==================================
// Level 4 Outputs - All Previous + Blob Storage & Monitoring
// ==================================
...
// Storage outputs (New in Level 4)
